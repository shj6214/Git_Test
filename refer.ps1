...
Get-ChildItem -path *.tfstate* -Recurse | Remove-Item -Force



Get-ChildItem -path .terraform -Recurse | Remove-Item -Force -Confirm
...
$VirtualMachine = New-AzVMConfig -VMName VM-Spoke-01 -VMSize "Standard_F2s_v2"
...
New-AzVm -ResourceGroupName $RG1 -Name "VM-Onprem" -Location $Location1 -VirtualNetworkName $VNetnameOnprem -SubnetName $SNNameOnprem -OpenPorts 3389 -Size "Standard_F2s_v2"
